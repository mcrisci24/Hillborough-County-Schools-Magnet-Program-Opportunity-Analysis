...
However, this difference is not purely attributable to individual race alone. Though, the other factors are likely a consequence of the long lasting impact of race driven policies such as well known policies prevelant in the south after the end of race based segregation in schools that still impact the communities it sought to oppress. Salvorte Saporito contends that magnet schools reinforced existing community divides rather than overcomming segregation barriers (Saporito, 2003). One may argue, the voluntary desegregation  tool only reinforced segregation and the result negatively impacts black students and hispanic students by a domino effect of factors. Saporitos' results suggest,  transportation limits, selective admissions, and parent self-selection influenced outcomes and maintained segregation by race and poverty (2003). Though we can't statistically say there is causal evidence with this data set, other studies such as with Saporito, demonstrate a lasting impact of race motivated policies such as race blind enrollment practices, as well as programs such as the magnet program that was claimed to be a tool of desegregation and later proved the latter. 

Furthermore, this supports the notion that discimination based on segregation continues to negatively impact the educational outcomes of black students and hispanic students today--when access to specialized educational paths such as Magnet programs. Research from the Learning Policy Institute highlights, students attending racially and economically segregated schools experience lower academic achievement and reduced long-term outcomes compared to students in more integrated environments (Learning Policy Institute, 2023). Disparities are reinforced by structural differences in funding, teacher quality, and peer composition, all of which are connected through the roots of segregation (Cook, 2024). Within school choice systems such as magnet programs, clearly, access is not evenly distributed. Studies found, higher-income and White families are more likely to avoid schools with higher concentrations of black students and hispanic students as well as students from low income backgrounds. This contributes to persistent racial and economic segregation (Saporito, 2003). 

According to a student by Yancey, the socioeconomic composition of schools has been shown to be a stronger determinant of student outcomes than racial composition alone (Yancey, 1995). While recent evidence confirms, U.S. schools remain deeply segregated by both race and class, sustaining significant opportunity gaps across districts (UCLA Civil Rights Project, 2025). These structural inequalities help explain why variables such as program availability, socioeconomic composition, and school diversity play a pivotal role in predicting magnet enrollment, in this study.

This suggest that disparities in Magnet program participation are not only attributable to individual characteristics, but are rooted to broader institutional and structural conditions seeded in the Jim Crow era that shape access to educational opportunities, today.
